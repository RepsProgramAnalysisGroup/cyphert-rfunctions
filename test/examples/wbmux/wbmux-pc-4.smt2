; Query 3 -- Type: InitialValues, Instructions: 11754
(set-option :produce-models true)
(set-logic QF_AUFBV )
(declare-fun rfwb_op () (Array (_ BitVec 32) (_ BitVec 8) ) )
(assert (let ( (?B1 (bvand  (bvlshr  ((_ zero_extend 24)  (select  rfwb_op (_ bv0 32) ) ) (_ bv1 32) ) (_ bv7 32) ) ) ) (and  (=  false (=  (_ bv1 32) ?B1 ) ) (=  false (=  (_ bv0 32) ?B1 ) ) ) ) )
(check-sat)
