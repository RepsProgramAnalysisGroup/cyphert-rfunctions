; Query 1283 -- Type: InitialValues, Instructions: 3940725
...
(assert (and  (=  (_ bv26 32) (bvand  (bvlshr  (bvor  (concat  (select  addrbase (_ bv3 32) ) (concat  (select  addrbase (_ bv2 32) ) (concat  (select  addrbase (_ bv1 32) ) (select  addrbase (_ bv0 32) ) ) ) ) ((_ zero_extend 16)  (concat  (select  addrofs (_ bv1 32) ) (select  addrofs (_ bv0 32) ) ) ) ) (_ bv11 32) ) (_ bv31 32) ) ) (=  false (=  (_ bv0 8) (select  except_started (_ bv0 32) ) ) ) ) )
(check-sat)
