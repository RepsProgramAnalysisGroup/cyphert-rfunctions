; Query 271 -- Type: InitialValues, Instructions: 1593337
...
(exit)
;   OK -- Elapsed: 2.794003e-02
;   Solvable: true
;     addrbase = [0,0,0,0]
;     addrofs = [0,0,255,255]
;     ex_spr_write = [0,255,255,255]
